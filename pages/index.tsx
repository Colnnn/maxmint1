  ...
  const MintMany = () => {
    ...
    return (
      <>
        ...
        />
        <p className="mx-auto mt-2">Min: 1 ; Max 3</p>
        </div>
      </>
    );
  };
    ...
    <>
      ...
      <div className="flex flex-col items-center min-h-screen mx-6">
        ...
        <div className="flex items-center justify-between w-full mt-3">
          <h1 className="text-2xl font-bold">My NFT Project</h1>
        ...
        {connected && (
          <p className="mr-auto text-sm">
            <span className="font-bold">Minted/Total:</span>{" "}
        ...
        <div className="flex items-start justify-center w-11/12 my-10">
          {connected ? (
              ...
              {new Date(mintStartDate).getTime() < Date.now() ? (
                <>
                  {isSoldOut ? (
                    ...
                    <>
                      <div className="flex flex-col w-1/1">
                        <h1 className="mb-10 text-3xl font-bold">How many would you like to mint?</h1>
                        <div className="flex flex-col w-1/1">
                        <MintMany />
                        </div>
                      </div>
            ...
            <p className="mb-10 text-2xl font-bold">Connect Wallet!</p>
          )}
        </div>
